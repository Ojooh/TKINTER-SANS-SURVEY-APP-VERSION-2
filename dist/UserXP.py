...
if os.path.exists("user_responses.json"):
    with open("user_responses.json", 'r+') as user_responses_file:
        user_responses = json.load(user_responses_file) 
else :
    with open("user_responses.json", 'w+') as user_responses_file:
...
def exit(window):
    ...
    root_exit.iconbitmap("halo_shield.ico")
    root_exit['bg'] = "#ffffff"
...
def getPosition():
    ...
    root.iconbitmap("halo_shield.ico")
    global v
    ...
    img3 = PhotoImage(file="nextbutton.png")
    btnnext = Button(
        root,
        image=img3,
        relief=FLAT,
    ...
    imgexit = PhotoImage(file='exitbutton.png')
    btnexit = Button(
        root,
        image=imgexit,
        relief=FLAT,
...
def categorySelected(user_r):
    ...
    if((limit == 0) or (limit % 2 != 0)):
        ...
        imgexit41 = PhotoImage(file='exitbutton.png')
        btnexit = Button(
            root,
            image=imgexit41,
            relief=FLAT,
        ...
        img42 = PhotoImage(file='backbutton.png')
        btnback = Button(
            image=img42,
            relief=FLAT,
            border=0,
...
def questionShow(level, val, no):
    ...
    imgexit4 = PhotoImage(file='exitbutton.png')
    btnexit = Button(
        root,
        image=imgexit4,
        relief=FLAT,
    ...
    img4 = PhotoImage(file='backbutton.png')
    btnback = Button(
        image=img4,
        relief=FLAT,
        border=0,
    ...
    img5 = PhotoImage(file='nextbutton.png')
    btnnext = Button(
        image=img5,
        relief=FLAT,
        border=0,
...
def showresult(cat, score):
    ...
    if len(user_responses) == 0:
        ...
        with open("user_responses.json", "w") as e:
...
def showResultWindow(score, percentage, defaults):
    ...
    img6 = PhotoImage(file='leveler.png')
    labelimage1 = Label(
        root,
        image=img6,
        background="#ffffff",
...
def showRecommendation(defs):
    ...
    root_rec.iconbitmap("halo_shield.ico")
    ...
    # imgexit3 = PhotoImage(file='exitbutton.png')
    # btnexit = Button(
    #     root_rec,
    #     image=imgexit3,
    #     relief=FLAT,
...
img1 = PhotoImage(file='user_awareness1.png')
labelimage1 = Label(
    root,
    image = img1,
    background = "#ffffff",
...
image3 = PhotoImage(file='adminbutton.png')
btnAdmin = Button(
    root,
    image=image3,
    relief=FLAT,
