...
#Open needed Files
getList = []
statinfo = os.stat("questions_answers.json")
...
def error_show(error):
    ...
    root_error.iconbitmap("halo_shield.ico")
...
def success_show(success):
    ...
    root_success.iconbitmap("halo_shield.ico")
...
def Authentication():   
    ...
    root_input.iconbitmap("halo_shield.ico")
...
def categoryBox(mode):
    ...
    if((mode == "edit" or mode == "delete") and (selected == ())):
        ...
        if mode == "create":
            ...
            root_que.iconbitmap("halo_shield.ico")
            ...
            with open("questions_answers.json", "w") as tempF:
